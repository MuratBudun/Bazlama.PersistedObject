/**
 * StatusBadge - Example custom UI component for status/role fields.
 *
 * Demonstrates how to create a project-specific component that:
 * - Renders a Select in forms (with colored options)
 * - Renders a Badge in table cells (with matching colors)
 * - Reads options from ui_props (defined in backend model)
 *
 * Backend usage:
 *   status: str = KeyField(
 *       default="draft",
